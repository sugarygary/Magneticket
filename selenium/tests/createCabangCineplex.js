...
async function tambahMenuCineplex() {
  ...
  try {
    ...
    driver
      .findElement(By.xpath('//input[@placeholder="Masukkan Nama Cabang"]'))
      .sendKeys("Lenmarc felix");
    ...
    driver.findElement(By.xpath("//option[@value='SURABAYA']")).click();

    await delay(1500);

    driver
      .findElement(By.xpath('//input[@placeholder="Masukkan Alamat"]'))
      .sendKeys("Jalan deket ptc surabaya");
    await delay(1500);
