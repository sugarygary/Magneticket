...
promotorRouter.get("/api-key", expressAsyncHandler(getAPIKey));
promotorRouter.get(
  "/event-ticket/:id",
  expressAsyncHandler(getSingleEventTicket)
);
...
promotorRouter.get(
  "/allEvent/:id/kategori",
  expressAsyncHandler(getKategoriEvent)
);
