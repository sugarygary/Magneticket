    ...
    const topMovies = [
      ...
      return (
        <div className="flex">
            ...
            <h1 className="text-2xl font-bold mb-2">Judul Event Terlaris</h1>
            <h2 className="text-lg mb-5">Per Bulan Ini</h2>
            <div className="">
                <table>
...
export default CardEventTerlaris