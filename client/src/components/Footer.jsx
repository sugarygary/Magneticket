...
const Footer = (props) => {
  return (
    ...
    // </div>
    <footer class="biruTua w-full">
      <div class="mx-auto w-full max-w-screen-xl px-6 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
            <Link to="/user/home" class="items-center">
              <img src={logo1} class="h-24 m-auto" />
              <div class="self-center text-center text-4xl font-magneticket whitespace-nowrap text-white">
                MAGNETICKET
              </div>
            </Link>
          </div>
