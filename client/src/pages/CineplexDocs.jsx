...
export const loadAPIKeyCineplex = async () => {
  try {
    const response = await client.get(`api/cineplex/api-key`);
    return response.data;
  } catch (error) {
    return error;
  }
};
export const CineplexDocs = () => {
    ...
    <div className="px-10">
      ...
      <div id="accordion-collapse" className="mb-20" data-accordion="collapse">
        ...
        >
          <div className="p-5 border border-b-0 border-gray-700 text-[#f8f8f8] bg-gray-900">
            ...
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              <tbody>
                <tr className="mb-2 text-lg font-bold">
                ...
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <td className="px-6 py-4">
                    ...
                    /partnership/cineplex/claim-ticket
                  </td>
                </tr>
        ...
        >
          <div className="p-5 border border-b-0 border-gray-700 text-[#f8f8f8] bg-gray-900">
            <div className="mb-2">
              Endpoint ini berfungsi untuk sinkronisasi kursi pembelian tiket
              secara offline
            </div>
            <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
              <tbody>
                ...
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <td className="px-6 py-4">
                    {process.env.BACKEND_URL}
                    /partnership/cineplex/offline-transaction
                  </td>
                </tr>
                <tr className="my-2 text-lg font-bold">
                  <td className="py-2">Body</td>
                ...
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                  ...
                  <td className="px-6 py-4">
                    ID jadwal penayangan yang tertera di halaman jadwal
                  </td>
                </tr>
                <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                  <th
                  ...
                  <td className="px-6 py-4">
                    Nomor kursi yang tersedia sesuai dengan studio dimana jadwal
                    penayangan diputar
                  </td>
                </tr>
                <tr className="my-2 text-lg font-bold">
