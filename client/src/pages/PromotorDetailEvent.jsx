  ...
  return (
    <div className="mx-10">
        <div className="flex shadow-2xl mb-5">
            <img src={`${process.env.BACKEND_URL}/promotor/eventposter-${data.event.data.eventTicket._id}.jpg`} alt="" className="w-48" />
            <div className="p-5  w-full">
            <p className="font-bold text-2xl ">{data.event.data.eventTicket.event_name}</p>
            <br />
            <table>
                <tr>
                <td>Tanggal </td>
